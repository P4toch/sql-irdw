if object_id('dbo.ExternalFileEUAirTicketSegmentVldKey_') is null begin
    execute('create procedure dbo.ExternalFileEUAirTicketSegmentVldKey_ as return 0')
end
go

print 'Altering stored procedure ExternalFileEUAirTicketSegmentVldKey_'
go

alter procedure dbo.ExternalFileEUAirTicketSegmentVldKey_ (
    @pExternalFileID int,
...
Description:
    Checks deletes potential PK violations in the EU air segment 
...
select ExternalFileID,RecordKey,SegmentNbr, count(*)
  from dbo.ExternalFileEUAirTicketSegmentStaging
...
select a.ExternalFileID, a.RecordKey, a.SegmentNbr
  from dbo.ExternalFileEUAirTicketSegmentStaging a
       inner join
...
while( 1=1 ) begin
    ...
    if exists (select *
                ...
                where ExternalFileID = @ExternalFileID and
                      ...
                      DuplicateCount > 1)
        begin
            delete from dbo.ExternalFileEUAirTicketSegmentStaging
