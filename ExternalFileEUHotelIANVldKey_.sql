if object_id('dbo.ExternalFileEUHotelIANVldKey_') is null begin
    exec('create procedure dbo.ExternalFileEUHotelIANVldKey_ as return 0')
end
go
 
print 'Altering stored procedure ExternalFileEUHotelIANVldKey_'
go

alter procedure dbo.ExternalFileEUHotelIANVldKey_ (
    @pExternalFileID int,
...
Description:
    Checks deletes potential PK violations in the EU Hotel IAN 
...
select ExternalFileID,RecordKey, count(*)
  from dbo.ExternalFileEUHotelIANStaging
...
select a.ExternalFileID, a.RecordKey
  from dbo.ExternalFileEUHotelIANStaging a
       inner join
...
while( 1=1 ) begin
    ...
    if exists (select *
               ...
               where ExternalFileID = @ExternalFileID and
                     ...
                     DuplicateCount > 1)
        begin
            delete from dbo.ExternalFileEUHotelIANStaging
